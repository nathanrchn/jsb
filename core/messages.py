...
# Define an alias for (input, output) pair
...
def few_shots_messages_formatter(task: str, schema: "Schema") -> List[Message]:
    examples = EXAMPLES_FOR_TASK.get(task, [])
...
GITHUB_EXAMPLES: List[InputOutput] = [
        (
...
EXAMPLES_FOR_TASK: Dict[str, List[InputOutput]] = {
    "Github_easy": GITHUB_EXAMPLES,
    "Github_hard": GITHUB_EXAMPLES,
    "Github_medium": GITHUB_EXAMPLES,
    "Github_trivial": GITHUB_EXAMPLES,
    "Github_ultra": GITHUB_EXAMPLES,
    "Snowplow": [
        (
